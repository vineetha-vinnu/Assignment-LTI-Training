...
class ProducerControllerTest {
    ...
    public void testGetAllCustomers() throws Exception{
	 ...
	 @Test
		...
		/*
		 * @Test public void testUpdatecCust() throws Exception{
		 * 
		 * String URI = "/bank/updateCustomer/{id}"; Customer_Bank cust = new
		 * Customer_Bank(); cust.setAge(22); cust.setId(21); cust.setName("Hari");
		 * cust.setTypeofAccount("Savings"); String jsonInput =
		 * this.converttoJson(cust); ResponseEntity<Customer_Bank> r=new
		 * ResponseEntity<>(HttpStatus.OK);
		 * 
		 * 
		 * Mockito.when(ProductSer.updateCustomer(Mockito.anyInt(),Mockito.any())).
		 * thenReturn(r); MvcResult mvcResult =
		 * this.mockMvc.perform(MockMvcRequestBuilders.put(URI,21).accept(MediaType.
